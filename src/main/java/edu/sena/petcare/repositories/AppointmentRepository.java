...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    /**
     * @Documented Busca citas en un rango de fechas/horas para verificar
     ...
     */
    List<Appointment> findByEmployeeIdAndAppointmentDateTimeBetween(Long employeeId, LocalDateTime start,
            LocalDateTime end);

    /**
     * @Documented Busca todas las citas de un empleado específico.
